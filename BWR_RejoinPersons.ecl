...
$.File_Persons.Layout_Persons Bulkup($.File_Persons_Slim.Layout L, $.File_LookupCSZ.Layout R) := TRANSFORM
...
BulkRecs:= JOIN(
  $.File_Persons_Slim.File, $.File_LookupCSZ.File, 
  LEFT.CSZ_ID = RIGHT.CSZ_ID,
  Bulkup(LEFT,RIGHT), LEFT OUTER, LOOKUP
);

OUTPUT(BulkRecs,,'~ONLINE::FGB::OUT::Persons_Rejoined',OVERWRITE);